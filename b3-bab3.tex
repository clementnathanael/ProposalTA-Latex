...
\begin{enumerate}
    \item Sistem memerlukan seorang \textit{knowledge engineer} untuk dapat mengelola pengetahuan yang didapat dari pakar.
        ...
        \end{itemize}
    \item Sistem harus mampu merepresentasikan pengetahuan dengan tingkat detail dan granularitas yang tinggi.
        \begin{itemize}
...
\begin{enumerate}
    \item Kinerja dan Skalabilitas (\textit{Scalability}).
        \begin{itemize}
            ...
            \item Arsitektur sistem harus dirancang untuk dapat menangani pertumbuhan \emph{knowledge graph} hingga ratusan \textit{node} dan relasi tanpa penurunan kinerja yang signifikan.
        \end{itemize}
...
\begin{enumerate}
    ...
    \item Pendekatan hibrida (otomatis dengan validasi pakar):
        \begin{itemize}
        ...
        \begin{enumerate}
            \item Penentuan bobot prioritas kriteria \\
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        \item K1 vs K2 (Akurasi vs Kelayakan): Akurasi dinilai sedikit lebih penting (nilai 3) daripada Kelayakan. Sebuah sistem yang layak dibuat namun tidak akurat tidak memiliki nilai guna.
                        \item K1 vs K3 (Akurasi vs Skalabilitas): Akurasi dinilai cukup lebih penting (nilai 5) daripada Skalabilitas. Lebih baik memiliki \textit{knowledge graph} kecil yang akurat daripada \textit{knowledge graph} besar yang penuh kesalahan.
                        ...
                        \item K2 vs K3 (Kelayakan vs Skalabilitas): Kelayakan TA dinilai sedikit lebih penting (nilai 3) daripada Skalabilitas. Proyek harus dapat diselesaikan terlebih dahulu sebelum memikirkan skala besar.
                    \end{itemize}
                \end{itemize} 
            ...
            \begin{itemize}
                \item Terhadap K1: Akurasi Pengetahuan
                    \begin{itemize}
                        \item Justifikasi: Manual paling akurat (diawasi 100\% oleh pakar). Hibrida di urutan kedua (ada validasi). Otomatis paling tidak akurat (risiko \emph{noise}). Manual dinilai sangat lebih akurat (7) dari Otomatis dan sedikit lebih akurat (3) dari Hibrida.
                        \item Hasil Bobot: Manual (0.63), Hibrida (0.27), Otomatis (0.10).
                    \end{itemize}
                \item Terhadap K2: Kelayakan Implementasi TA
                    \begin{itemize}
                        \item Justifikasi: Manual paling layak (risiko teknis rendah). Otomatis dan Hibrida sangat tidak layak karena memerlukan keahlian NLP mendalam yang berada di luar lingkup. Manual dinilai mutlak lebih layak (9) dari Otomatis dan sangat lebih layak (7) dari Hibrida.
                        \item Hasil Bobot: Manual (0.70), Hibrida (0.20), Otomatis (0.10).
                    \end{itemize}
                \item Terhadap K3: Skalabilitas
                    \begin{itemize}
                        \item Justifikasi: Otomatis paling skalabel (memproses ribuan dokumen). Hibrida di urutan kedua. Manual sangat tidak skalabel. Otomatis dinilai sangat lebih skalabel (7) dari Manual.
                        \item Hasil Bobot: Otomatis (0.65), Hibrida (0.25), Manual (0.10).
                    \end{itemize}
                \item Terhadap K4: Efisiensi Keterlibatan Pakar
                    \begin{itemize}
                        \item Justifikasi: Otomatis paling efisien (intervensi pakar minimal). Hibrida membutuhkan waktu untuk validasi. Manual paling boros waktu pakar. Otomatis dinilai sangat lebih efisien (7) dari Manual.
                        \item Hasil Bobot: Otomatis (0.62), Hibrida (0.27), Manual (0.11).
                    \end{itemize}
                \end{itemize}
            \end{enumerate}
        ...
        \begin{enumerate}
            \item Ringkasan bobot prioritas \\
                Tabel \ref{tab:bobot-ringkasan} merangkum semua bobot yang telah dihitung.
                    ...
                    A3: Hibrida & 0.27 & 0.20 & 0.25 & 0.27 \\ \hline
                    \end{tabular}
                    \end{table}
            ...
            \begin{itemize}
                ...
                \item Skor Pendekatan Hibrida: \\ $(0.55 \times 0.27) + (0.26 \times 0.20) + (0.13 \times 0.25) + (0.06 \times 0.27) = 0.149 + 0.052 + 0.033 + 0.016 = \mathbf{0.250}$
            \end{itemize}
            ...
            Pendekatan Hibrida & 0.250 & 2 \\ \hline
