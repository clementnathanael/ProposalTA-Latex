...
Berdasarkan \textit{gantt chart} tersebut, akan dialokasikan sekitar 5 bulan untuk melakukan pengembangan KBS, mulai dari fase identifikasi pada minggu pertama dan kedua di bulan Januari, fase konseptualisasi pada minggu ketiga bulan Januari hingga minggu kedua bulan Februari, fase formalisasi dari minggu ketiga bulan Februari hingga minggu ketiga bulan Maret, fase implementasi dari minggu keempat bulan Maret hingga minggu pertama bulan Mei, dan terakhir untuk fase pengujian dimulai dari minggu kedua hingga minggu kelima bulan Mei.
